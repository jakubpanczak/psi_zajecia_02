...
#install.packages("dplyr")     # Manipulacja danymi [cite: 181]
#install.packages("ggplot2")   # Wizualizacja [cite: 314]
#install.packages("readxl")    # Odczyt Excel [cite: 90]
#install.packages("writexl")   # Zapis Excel [cite: 418]
#install.packages("rmarkdown") # Generowanie raportów
